            ...
            @if ($courses != Null)
              ...
              <div class="course bg-white rad-6 p-relative">
                @if ($course->image)
                  ...
                  <img class="cover" src="{{ asset('storage/' . $course->image) }}" alt="" />
                  @else
                  <img class="cover" src="images/bg-img.jpg" alt="" />
  ...
  <div>
    ...
    @foreach ($A_courses as $course)
        ...
        <div class="course bg-white rad-6 p-relative" style="width: 18rem;" >
            ...
            <img class="cover" style="height: 50%;width:100%" src="{{ asset('storage/' . $course->image) }}" alt="" />
            @else
            <img class="cover" style="height: 50%;width:100%;" src="images/bg-img.jpg" alt="" />
